...
It filters the all of the data returning only the objects where `d.state === state`. 
...
Now we need a y scale. This needs to map the map the rain fall value in inches to the height our SVG viewport in pixels. 
